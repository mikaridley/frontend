...
import {
  ...
  addItemToChecklist,
} from './taskDetailsCmps/taskDetailschecklist'
...
export function TaskDetails() {
  ...
  async function toggleChecklistItem(checklistId, itemIndex) {
    ...
    try {
      ...
      await updateTask(board, groupId, taskId, {
                ...
                <div className="attachments-list">
                  {attachments.map(attachment => (
                    <div key={attachment.id} className="attachment-item">
                      ...
                      <button
                        className="btn-show-attachment"
                        title="Show attachment"
                        onClick={() =>
                          taskService.openAttachmentInNewTab(attachment.file)
                        }
                      >
                        <img src={arrowIcon} alt="show attachment" />
                      </button>
                      <button
